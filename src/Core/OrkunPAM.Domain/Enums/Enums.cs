...
public enum AuthSource : byte { Local = 0, ActiveDirectory = 1, Saml = 2, Oidc = 3, Windows = 4, SCIM = 5 }
...
public enum GroupSource : byte { Local = 0, ActiveDirectory = 1, Saml = 2, SCIM = 3 }
...
public enum RotationScriptType : byte { PowerShell = 0, Bash = 1, Python = 2 }
